...
<head>
  	...
  	<!-- Bootstrap 3.3.7 -->
  	<link rel="stylesheet" href="../dist/plugins/bootstrap/dist/css/bootstrap.min.css">
  	<!-- Font Awesome -->
  	<link rel="stylesheet" href="../dist/plugins/font-awesome/css/font-awesome.min.css">
    <!-- Select2 -->
    <!-- <link rel="stylesheet" href="../dist/plugins/select2/dist/css/select2.min.css"> -->
  	<!-- Theme style -->
  	<link rel="stylesheet" href="../dist/css/AdminLTE.min.css">
  	<!-- DataTables -->
    <link rel="stylesheet" href="../dist/plugins/datatables.net-bs/css/dataTables.bootstrap.min.css">
    <!-- daterange picker -->
    <!-- <link rel="stylesheet" href="../dist/plugins/bootstrap-daterangepicker/daterangepicker.css"> -->
